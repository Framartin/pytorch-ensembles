#!/bin/bash -l
# launch with:
# bash train_imagenet_csgld_googlenet_resume2_debug.sh >>log/run_train_imagenet_csgld_googlenet_resume2_debug.log 2>&1
...
python -u train_imagenet_csgld.py --data $DATAPATH --no-normalization --arch $ARCH \
  ...
  --resume "../models/ImageNet/googlenet/cSGLD_cycles3_samples3_bs256_lr0.1_wd0.00004/ImageNet-cSGLD_googlenet_00043.pt.tar"  # try resume from previous sample
