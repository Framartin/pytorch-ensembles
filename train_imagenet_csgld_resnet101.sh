#!/bin/bash -l
# bash train_imagenet_csgld_resnet101.sh >>log/run_train_imagenet_csgld_resnet101.log 2>&1
...
WORKERS=10
PRINT_FREQ=400
DIR="../models/ImageNet/${ARCH}/cSGLD_cycles${CYCLES}_samples${SAMPLES_PER_CYCLE}_bs${BATCH_SIZE}_lr${LR}"
